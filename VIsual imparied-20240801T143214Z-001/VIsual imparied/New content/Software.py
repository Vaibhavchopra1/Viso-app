...
ap.add_argument("-p/", "--prototxt", required = True,  help = "C:\\Users\\VAIBHAV\\Desktop\\Competitons\\VIsual imparied\\New content\\labels.txt")
ap.add_argument("-m/", "--model", required = True, help = "C:\\Users\\VAIBHAV\\Desktop\\Competitons\\VIsual imparied\\New content\\model.pb")
ap.add_argument("-c/", "--probability", type = float, default = 0.2, help = "0.3")
args = vars(ap.parse_args())

# initialize the list of class labels MobileNet SSD was trained to detect
# and generate a set of bounding box colors for each class
CLASSES = ["Chair","Bed","Sofa","Table"]
